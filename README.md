...
See [agent.md](agent.md) for guidance on how AI coding and design agents should apply RDS without turning it into a prompt pack or speculative component factory.
